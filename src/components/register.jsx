                ...
                render={({field: {onChange, value, onBlur}, fieldState: {error}}) => (
                    <>
                        <FormControlLabel className={styles.labelCont} value="standard"
                                          label={<span className={styles.checkboxLabel}>I agree to terms & conditions</span>}
                                          control={<Checkbox style={{color: '#f82e56'}}
                                                             value={value} onChange={onChange}
                                                             onBlur={onBlur}/>}/>
                        <FormHelperText className={styles.helperText}>{error ? error.message : null}</FormHelperText>
                    </>
                )}
                rules={{min: {value: true, message: 'You must agree to terms.'}}}
            />
